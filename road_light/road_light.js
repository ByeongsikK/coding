$(document).ready(function () {
    ...
    $(`.logout`).click(function () {
        ...
        $(`.my_minwon`).show();
        $(`.my_list`).hide();
        $(`.ganpyeon_bt`).removeClass(`singo_sign`).end();
        $(`.ganpyeon_bt`).removeClass(`cheoli_sign`).end();
        $(`.menu a:first`).removeClass(`singo1`).end();
        $(`.menu a:first`).removeClass(`singo2`).end();
        $(`.menu a:last`).removeClass(`cheoli2`).end();
        $(`.menu a:last`).removeClass(`cheoli1`).end();
        $(`.menu a:last`).click(function () {
            $(`.main`).hide();
            $(`.sec3`).show();
            $(`.my_list`).hide();
